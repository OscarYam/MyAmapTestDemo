...
//    @Deprecated
    ...
    static final String IANA_TOP_LEVEL_DOMAINS = "(?:"
            ...
            + "|f[ijkmor])" + "|(?:gal|gallery|game|garden|gbiz|gdn|gea|gent|genting|ggee|gift|gifts|gives|giving"
...
//    @Deprecated
     ...
     */
    private static final String EMAIL_ADDRESS_LOCAL_PART = "[" + EMAIL_CHAR + "]" + "(?:[" + EMAIL_CHAR
            + "\\.]{0,62}[" + EMAIL_CHAR + "])?";
