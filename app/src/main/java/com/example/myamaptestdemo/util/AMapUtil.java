 ...
 * 
 */
package com.example.myamaptestdemo.util;
...
//			LatLng latLngTemp = com.amap.map3d.demo.util.AMapUtil.convertToLatLng(point);
			LatLng latLngTemp = com.example.myamaptestdemo.util.AMapUtil.convertToLatLng(point);
